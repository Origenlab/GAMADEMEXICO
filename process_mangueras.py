#!/usr/bin/env python3
"""
Script para procesar imágenes de Mangueras Millhose contra Incendios
...
# Productos de mangueras - SOLO MILLHOSE
PRODUCTS = {
    "manguera-millhose-1-5-15m": ["frontal", "enrollada", "detalle", "acoples", "gabinete"],
    "manguera-millhose-1-5-30m": ["frontal", "enrollada", "detalle-forro", "acoples", "instalada"],
    "manguera-millhose-2-5-15m": ["frontal", "enrollada", "conexion", "acoples", "brigada"],
    "manguera-millhose-2-5-30m": ["frontal", "enrollada", "detalle", "desplegada", "acoples"],
    "manguera-millhose-amarilla": ["frontal", "detalle", "desplegada", "aeropuerto", "noche"],
    "manguera-millhose-elkhart": ["frontal", "enrollada", "acoples", "certificacion", "marca"],
    "manguera-millhose-nbr": ["frontal", "enrollada", "detalle", "aplicacion", "industrial"],
    "manguera-millhose-storz": ["frontal", "detalle", "conexion", "acople", "brigada"],
}
...
def get_source_images():
    ...
    for img in sorted(images):
        base = os.path.basename(img).replace(" (1)", "").replace("(1)", "")
...
def main():
    print("=" * 70)
    print("  PROCESADOR DE IMÁGENES - MANGUERAS MILLHOSE")
    print("=" * 70)
    ...
    # Eliminar SOLO imágenes AVIF de Millhose existentes (placeholders)
    print("\nEliminando placeholders existentes de Millhose...")
    old_images = glob.glob(os.path.join(IMG_DIR, "manguera-millhose-*.avif"))
