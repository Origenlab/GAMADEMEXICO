#!/usr/bin/env python3
"""
Script para procesar imágenes de Mangueras de Succión contra Incendios
Kit Eastrans - Manguera PVC verde, colador de acero, adaptador cam & groove
Convierte a AVIF 40-45%
"""
...
# Productos de mangueras - SOLO SUCCIÓN
PRODUCTS = {
    "manguera-succion-2-5-3m": ["frontal", "acople", "bomba", "operacion", "portatil"],
    "manguera-succion-4-3m": ["frontal", "helicoidal", "acople", "bomba", "operacion"],
    "manguera-succion-4-6m": ["frontal", "enrollada", "acople", "cisterna", "operacion"],
    "manguera-succion-6-3m": ["frontal", "helicoidal", "storz", "bomba", "industrial"],
    "manguera-succion-colador": ["frontal", "canastilla", "malla", "instalado", "operacion"],
    "manguera-succion-flotador": ["frontal", "detalle", "agua", "operacion", "rio"],
    "manguera-succion-nbr": ["frontal", "corte", "acople", "industrial", "petrolera"],
    "manguera-succion-transparente": ["frontal", "espiral", "conexion", "flujo", "uso"],
}
...
def main():
    print("=" * 70)
    print("  PROCESADOR DE IMÁGENES - MANGUERAS DE SUCCIÓN")
    print("  Kit Eastrans - PVC Verde + Colador Acero + Adaptador Cam & Groove")
    print("=" * 70)
    ...
    # Eliminar SOLO imágenes AVIF de Succión existentes (placeholders)
    print("\nEliminando placeholders existentes de Succión...")
    old_images = glob.glob(os.path.join(IMG_DIR, "manguera-succion-*.avif"))
