---
nombre: Complejo Automotriz Internacional — Guanajuato
slug: "complejo-automotriz-internacional-guanajuato"
...
2. [Estándar Global el fabricante-WFG-FPS](#estandar-gm)
...
8. [Servicios de Emergencia el fabricante](#servicios-emergencia)
...
| **Motores (el fabricanteEP)** | 2008 | $1,000M | 220,000 m² | Ecotec 1.0-2.5L |
...
> *"Zero tolerance for fire-related production interruption. Every el fabricante facility shall be designed, constructed, and maintained to prevent fire ignition, limit fire spread, and ensure life safety."*
> — el fabricante Global Engineering Standards, 2023 Edition
...
| Supervisor de turno | 1 (certificado el fabricante-ICS) |
| Cobertura | 24/7/365 |
...
|----------|----------|---------------|
| Jefe de Bomberos | 1 | NFPA 1021 Fire Officer IV + el fabricante-FPC-001 |
...
| Autobomba #4 | KME Predator | 2,500 gal + 300 espuma | el fabricanteEP |
...
| Escenario | Objetivo el fabricante | Desempeño Real |
|-----------|-------------|----------------|
...
| 2006-2010 | $32,000,000 | el fabricanteEP + modernización GAP |
...
| el fabricante-WFG-FPS | el fabricante Global | 1995 | Cumplimiento total |
