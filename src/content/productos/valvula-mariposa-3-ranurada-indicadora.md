...
La **válvula mariposa GD-4765-3N** de Nibco con extremos ranurados combina la versatilidad de instalación con acople mecánico y la funcionalidad de supervisión integrada. Perfecta para sistemas modernos.
...
- Control de zonas
- Retrofits industriales

## Posiciones de Bloqueo

| Posición | Indicador | Uso |
|----------|-----------|-----|
| Cerrada | Rojo visible | Aislamiento |
| Abierta | Verde visible | Operación normal |
| Intermedia | No recomendada | Solo ajuste |
