...
Toma siamesa con salida Storz de 4" para conexión rápida al sistema. Combina entradas NH estándar con salida de acoplamiento rápido de cuarto de vuelta.

## Características principales

- Dos entradas: 2.5" NH hembra swivel
- Salida: Storz 4" para conexión rápida
- Válvulas clapper integradas
- Conexión de cuarto de vuelta
- Capacidad: 1,000 GPM total

## Materiales

- Cuerpo: bronce fundido
- Acoplamiento Storz: aluminio o bronce
