...
Un proveedor que solo vende producto es un almacén con facturas. Un proveedor que además puede orientar sobre la especificación correcta para cada aplicación evita errores que después cuestan mucho más que la diferencia de precio entre equipos. ¿El proyecto requiere FM Approved o basta con UL Listed? ¿La [boquilla](/boquillas/) es compatible con solución de espuma AFFF o solo con agua? ¿La manguera tiene la presión de trabajo correcta para la red donde se va a instalar? ¿Los [adaptadores](/conexiones-herrajes/) son del estándar que usa el cuerpo de bomberos del municipio?
