...
imagenAlt: "Herrajes de bronce para sistemas contra incendios instalados"
tags: ["herrajes contra incendios", "soportes mangueras", "gabinetes contra incendios", "NOM-002-STPS", "instalación NFPA"]
destacado: false
draft: false
tiempoLectura: 16
...
schema:
  - type: "Article"
    headline: "Herrajes y Soportes para Mangueras y Gabinetes Contra Incendios"
  ...
  - type: "FAQPage"
    questions:
      - q: "¿Qué herrajes necesita un gabinete de manguera contra incendios?"
        a: "Un gabinete completo necesita: devanadera o rack porta-manguera interno, bisagras de acero con capacidad para el peso de la puerta con vidrio, cerradura o mecanismo de apertura rápida, soporte de boquilla y gancho o sujeción para la llave de operación. La ausencia de cualquiera de estos herrajes compromete la operación del gabinete."
      - q: "¿Cada cuánto se deben inspeccionar los herrajes de gabinetes contra incendios?"
        a: "Inspección visual mensual verificando que bisagras operan sin resistencia, puerta abre completamente, cerradura no está trabada, devanadera gira libremente y no hay corrosión visible. Inspección detallada semestral con lubricación de bisagras y mecanismos. NFPA 1962 y NOM-002-STPS establecen estas frecuencias."
      - q: "¿Qué material es mejor para herrajes contra incendios: acero galvanizado o acero inoxidable?"
        a: "Acero galvanizado para ambientes interiores secos o templados. Acero inoxidable 304 o 316 para ambientes húmedos, costeros o con exposición a químicos. El galvanizado cuesta 40-60% menos pero se deteriora en ambientes agresivos en 3-5 años. El inoxidable dura décadas pero su costo solo se justifica donde el ambiente lo exige."
      - q: "¿Por qué la bisagra del gabinete contra incendios es tan importante?"
        a: "Una bisagra que no abre completamente o que requiere fuerza excesiva retrasa el acceso a la manguera durante una emergencia. Una bisagra corroída puede trabarse completamente, haciendo el gabinete inaccesible. La bisagra debe permitir apertura de 170 grados mínimo para que el brigadista extraiga la manguera sin obstáculos."
---

Los herrajes de un sistema contra incendios son las piezas que nadie menciona cuando el sistema funciona y las primeras que aparecen como causa cuando el sistema falla. Una bisagra de [gabinete](/gabinetes/) que se corroyó y no permite abrir la puerta. Una devanadera que se trabó y no deja desplegar la [manguera](/mangueras/). Una abrazadera de tubería que cedió y permitió que un tramo de tubería se moviera lo suficiente para fracturar una conexión. Un soporte de [monitor](/monitores/) que no resistió la vibración de las pruebas de flujo y empezó a tener juego lateral. Cada una de esas fallas tiene su origen en un herraje que no se especificó correctamente, no se instaló correctamente o no se mantuvo.

En la jerarquía de costos de un sistema contra incendios, los herrajes representan una fracción mínima: probablemente menos del dos por ciento del costo total del proyecto. Pero esa fracción mínima soporta, conecta, fija y permite el acceso a todo lo demás. Comprar una bomba de 1500 GPM, instalar cien metros de tubería de seis pulgadas y equipar diez gabinetes con [manguera](/mangueras/) certificada y [boquilla](/boquillas/) UL Listed para luego ahorrar doscientos pesos en la bisagra del gabinete y descubrir dos años después que la bisagra se corroyó y la puerta no abre es el tipo de economía que convierte una inversión seria en una instalación con defectos que el inspector de protección civil va a documentar.

## Herrajes de gabinete: lo que hace que el gabinete sea operativo

Un [gabinete de manguera](/gabinetes/) contra incendios no es una caja roja con una manguera adentro. Es un sistema de acceso rápido que debe permitir que un brigadista abra la puerta, extraiga la manguera, la despliegue y la conecte a la [válvula](/valvulas/) angular en menos de sesenta segundos. Cada herraje del gabinete contribuye a esa secuencia o la obstaculiza.
