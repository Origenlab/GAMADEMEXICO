...
La solución técnica pasa por una combinación de dimensionamiento correcto de la tubería del colector para minimizar la pérdida de presión entre la primera y la última derivación, [válvulas](/valvulas-contra-incendios) de balanceo en las salidas que lo requieran, y un cálculo hidráulico que modele la red completa con todas las condiciones de demanda simultánea que el sistema debe satisfacer. En plantas grandes, ese cálculo se hace con software especializado porque las interacciones entre sistemas son demasiado complejas para resolverse con ecuaciones manuales.
