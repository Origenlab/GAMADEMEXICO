...
En [Gama de México](/equipos/) distribuimos los componentes del sistema de protección contra incendios que complementan la protección de cocinas: [gabinetes de manguera](/gabinetes/) para primera intervención en áreas adyacentes, [boquillas tipo pistola](/boquillas/tipo-pistola) para brigadas internas, [extintores clase K](/equipos/) de agente húmedo como respaldo portátil del sistema automático, y [válvulas](/valvulas/) para la integración del sistema con la red contra incendios del edificio. Si necesitas evaluar la protección de la cocina de tu hotel, restaurante, hospital o comedor industrial, desde [**/cotizar**](/cotizar) lo revisamos con el criterio técnico que UL 300 y NFPA 17A exigen.
